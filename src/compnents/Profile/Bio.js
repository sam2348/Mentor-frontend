  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 gap-4 bg-slate-100">
          ...
          {data?<i onClick={BioHandleOpen} className="fa-solid fa-pen border-solid  ring-2 ring-gray-200 p-2 rounded-full" />
          :<i onClick={BioHandleOpen} className="fa-solid fa-plus border-solid  ring-2 ring-gray-200 p-2 rounded-full" />}
